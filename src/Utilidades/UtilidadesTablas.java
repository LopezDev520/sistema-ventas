...
public class UtilidadesTablas {
    ...
    // Metodo para llenar una tabla a partir de una consulta SQL
    ...
    public static void mostrarTabla(String[] columnas, String sqlQuery, JTable tabla, Class[] tiposDatosColumnas, SetterStatement setter) {
        DefaultTableModel modelo = new DefaultTableModel();
        for (String col : columnas) {
            modelo.addColumn(col);
        }
