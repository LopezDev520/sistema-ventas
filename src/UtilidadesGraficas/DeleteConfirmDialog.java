...
public class DeleteConfirmDialog extends javax.swing.JDialog {

    private boolean aceptado;
    
    public DeleteConfirmDialog(java.awt.Frame parent, String msg) {
        super(parent, true);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblMsg.setFont(lblMsg.getFont().deriveFont((lblMsg.getFont().getStyle() & ~java.awt.Font.ITALIC), lblMsg.getFont().getSize()+5));
